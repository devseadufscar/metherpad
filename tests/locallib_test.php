...
/**
 * Tests for mod/assign/submission/metherpad/locallib.php
 *
...
/**
 * Unit tests for mod/assign/submission/metherpad/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignsubmission_metherpad_locallib_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $params = ['course' => $this->course->id, 'assignsubmission_metherpad_enabled' => 1];
    ...
    public function test_submission_is_empty($submissiontext, $expected) {
        ...
        $data = new stdClass();
        $data->metherpad_editor = ['text' => $submissiontext];
