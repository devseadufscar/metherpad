...
/**
 * The assignsubmission_metherpad assessable uploaded event.
 *
...
/**
 * The assignsubmission_metherpad assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has saved an metherpad submission with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'assignsubmission_metherpad');
    }
