...
/**
 * The assignsubmission_metherpad submission_updated event.
 *
...
/**
 * The assignsubmission_metherpad submission_updated event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int metherpadwordcount: Word count of the online text submission.
 * }
 *
 * @package    assignsubmission_metherpad
 * @since      Moodle 3.2
...
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' updated an metherpad submission with " .
